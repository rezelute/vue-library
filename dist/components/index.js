...
const gi = /* @__PURE__ */ Dt(pi, [["render", fi]]), bi = {
  ...
  key: "error",
  class: "w-full"
}, $i = { class: "vstack-sm p-12 text-center items-center" }, Ii = { class: "w-96" }, Si = { class: "bg-surface-50 py-1 px-6" }, wi = { key: "loaded" }, xi = /* @__PURE__ */ j({
  __name: "PageLoader",
  props: {
        ...
        e.showLoading ? (p(), b("div", bi, [
          ...
          S(n.$slots, "error", {}, () => [
            g("div", $i, [
              ...
              g("p", Si, M(e.errorText || "Something went wrong, please try again later."), 1),
              P(z(K), {
                label: "Retry",
                type: "button",
...
}), ja = /* @__PURE__ */ Dt(xi, [["__scopeId", "data-v-71973e10"]]), Ci = {
  key: 0,
  class: "bar"
}, Pi = /* @__PURE__ */ j({
  ...
  setup(e) {
    return (t, n) => e.isLoading ? (p(), b("div", Ci, [...n[0] || (n[0] = [
      g("div", null, null, -1)
    ])])) : k("", !0);
  }
}), Va = /* @__PURE__ */ Dt(Pi, [["__scopeId", "data-v-61696455"]]);
var Qt = {
  name: "TimesIcon",
  extends: _t
};
function _i(e) {
  return zi(e) || Oi(e) || Ti(e) || Li();
}
function Li() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function or(e, t, n) {
  return (t = ir(t)) in e ? Object.defineProperty(e, t, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = n, e;
}
function ir(e) {
  var t = rr(e, "string");
        ...
        default: x(function() {
          return [e.visible ? Et((p(), b("div", f({
            ...
            return [e.header ? (p(), b("span", f({
              ...
              class: e.cx("title")
            }, e.ptm("title")), M(e.header), 17, lr)) : k("", !0)];
          }), g("div", f({
            ...
            "data-p": i.dataP
          }, $e($e({}, e.contentProps), e.ptm("content"))), [S(e.$slots, "default")], 16, ur), e.footer || e.$slots.footer ? (p(), b("div", f({
            key: 1,
    ...
    return (t, n) => (p(), b("div", cr, [
      P(z(Ge), {
        ...
        default: x(() => [
          g("div", pr, [
            P(z(Jt)),
            e.loadingText ? (p(), b("div", mr, M(e.loadingText), 1)) : k("", !0)
          ])
        ]),
        _: 1
      }, 8, ["visible", "header"])
...
}, Cr = { class: "text-primary break-all" }, Pr = {
  key: 1,
  class: "flex flex-col sm:flex-row gap-0 sm:gap-2"
}, _r = { class: "text-primary break-all sm:pl-2" }, Lr = {
  key: 1,
  class: "vstack-sm"
}, Fa = /* @__PURE__ */ j({
      ...
      content: x(() => [
        e.isLoading ? (p(), b("div", Lr, [
          ...
          e.userId ? (p(), b("div", xr, [
            ...
            g("div", null, [
              g("code", Cr, M(e.userId), 1)
            ])
          ])) : k("", !0),
          e.userEmail ? (p(), b("div", Pr, [
            n[2] || (n[2] = g("div", { class: "block sm:flex font-bold" }, [
              g("span", null, "Email"),
              g("span", { class: "hidden sm:block" }, ":")
            ], -1)),
            g("div", null, [
              g("strong", _r, M(e.userEmail), 1)
            ])
          ])) : k("", !0)
        ]))
      ]),
...
var Zr = ["data-p"], Xr = ["data-p"], Yr = ["data-p"], Jr = ["aria-label", "data-p"], Qr = ["data-p"];
  ...
  return p(), _(Pt, f({
    ...
    default: x(function() {
      return [r.visible ? (p(), b("div", f({
        ...
        class: e.cx("text"),
        "data-p": i.dataP
      }, e.ptm("text")), [S(e.$slots, "default")], 16, Yr)) : k("", !0), e.closable ? Et((p(), b("button", f({
        key: 1,
        ...
        return [e.closeIcon ? (p(), b("i", f({
          ...
          "data-p": i.dataP
        }, e.ptm("closeIcon")), null, 16, Qr)) : (p(), _(l, f({
          key: 1,
          class: [e.cx("closeIcon"), e.closeIcon],
          "data-p": i.dataP
        }, e.ptm("closeIcon")), null, 16, ["class", "data-p"]))];
      })], 16, Jr)), [[u]]) : k("", !0)], 16, Xr))], 16)], 16, Zr)) : k("", !0)];
    }),
    _: 3
  }, 16);
}
te.render = ta;
const ea = { class: "flex flex-col gap-1" }, na = ["for"], oa = {
  key: 1,
  class: "text-sm text-gray-500"
}, ia = { class: "mt-1" }, ee = /* @__PURE__ */ j({
  __name: "FormField",
  props: {
    id: {},
    label: {},
  ...
  setup(e) {
    return (t, n) => (p(), b("div", ea, [
      e.label ? (p(), b("label", {
        key: 0,
        for: e.id,
        class: "font-medium"
      }, M(e.label), 9, na)) : k("", !0),
      e.helper ? (p(), b("p", oa, M(e.helper), 1)) : k("", !0),
      g("div", ia, [
        S(t.$slots, "default")
      ]),
      e.error ? (p(), _(z(te), {
...
}), ra = "Please enter a valid email address", Ze = /* @__PURE__ */ j({
  __name: "EmailInput",
  props: /* @__PURE__ */ tt({
...
}), aa = { class: "flex flex-col items-center gap-4 text-center" }, sa = { class: "flex flex-col gap-2" }, Xe = /* @__PURE__ */ j({
  __name: "ActionConfirmMsg",
  props: {
    iconClass: {}
  },
  setup(e) {
    return (t, n) => (p(), b("div", aa, [
      g("i", {
...
}), la = { key: 0 }, ua = { class: "text-primary break-all px-2" }, Na = /* @__PURE__ */ j({
...
}), ca = { class: "vstack-form" }, pa = "Name can be letters only, at least 2 characters and max 50 characters", Ra = /* @__PURE__ */ j({
  __name: "NameInput",
  props: /* @__PURE__ */ tt({
    label: {},
    placeholder: {},
...
}), ma = { class: "gsi-material-button-content-wrapper" }, fa = { class: "gsi-material-button-icon" }, ga = {
  version: "1.1",
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  "xmlns:xlink": "http://www.w3.org/1999/xlink",
  style: { display: "block" }
}, ba = { class: "gsi-material-button-contents" }, ha = { style: { display: "none" } }, va = /* @__PURE__ */ j({
  ...
  setup(e) {
    return (t, n) => (p(), b("button", {
      ...
      g("div", ma, [
        ...
        g("span", ha, M(e.authType === "sign-up" ? "Sign Up" : "Sign In") + " with Google ", 1)
      ])
    ]));
  }
}), ya = /* @__PURE__ */ Dt(va, [["__scopeId", "data-v-78faf8cc"]]), ka = { class: "h1" }, $a = { key: 1 }, Ia = {
  key: 1,
  ...
  setup(e, { emit: t }) {
    ...
    return (s, a) => (p(), _(z(it), { class: "max-w-xl p-12 w-full" }, {
      title: x(() => [
        g("h1", ka, M(e.pageAuthType === "sign-up" ? "Sign Up" : "Sign In"), 1)
      ]),
      content: x(() => [
        ...
        e.isSignupInviteOnly && e.pageAuthType === "sign-in" || !e.isSignupInviteOnly ? (p(), b("section", $a, [
          e.enableThirdPartyAuth?.useGoogle ? (p(), _(ya, {
            key: 0,
...
Ye.render = Pa;
const _a = { class: "px-4 py-8 sm:p-8" }, La = { class: "flex flex-col items-stretch gap-4 sm:flex-row sm:items-start" }, Ta = { class: "vstack-form" }, Oa = { class: "vstack-form" }, Ha = /* @__PURE__ */ j({
