import { q as be, m as A, t as fe, E as he, B as X, R as Y, s as R, k as ee, n as te, v as pe, w as j, x as Ie, y as k, z as T, A as E, C as G, D as U, j as S, F as q, G as z, H as ge, u as ve, S as ye, l as ke, _ as Le } from "../PageLoader.vue_vue_type_script_setup_true_lang-B6C13Gir.js";
import { o as zt } from "../PageLoader.vue_vue_type_script_setup_true_lang-B6C13Gir.js";
import { renderSlot as x, createBlock as g, createCommentVNode as p, openBlock as u, Teleport as xe, defineComponent as _, ref as D, computed as N, unref as I, mergeProps as m, resolveDirective as ne, createElementBlock as c, createElementVNode as h, withDirectives as ie, resolveDynamicComponent as O, normalizeClass as C, toDisplayString as H, resolveComponent as K, withCtx as L, createVNode as y, Transition as Pe, Fragment as P, renderList as B, createTextVNode as V, normalizeStyle as Ce, normalizeProps as we, guardReactiveProps as Se, onMounted as Oe } from "vue";
function Me() {
  let t = [];
  const e = (a, b, s = 999) => {
    const l = o(a, b, s), d = l.value + (l.key === a ? 0 : s) + 1;
...
function Ue(t, e, n, r, o, i) {
  ...
  }, null, 8, ["item", "label", "props"])) : p("", !0) : ie((u(), c("a", m({
    key: 0,
    href: n.item.url,
    class: t.cx("itemLink"),
  ...
  }, null, 8, ["item", "class"])) : n.item.icon ? (u(), c("span", m({
    key: 1,
    class: [t.cx("itemIcon"), n.item.icon],
    "data-p": i.dataP
  }, i.getPTOptions("itemIcon")), null, 16, Ze)) : p("", !0), h("span", m({
  ...
  return u(), g(b, {
    ...
    default: L(function() {
      return [y(Pe, m({
        ...
        default: L(function() {
          return [!t.popup || o.overlayVisible ? (u(), c("div", m({
            key: 0,
            ref: i.containerRef,
            id: t.$id,
            class: t.cx("root"),
            ...
            "data-p": i.dataP
          }, t.ptmi("root")), [t.$slots.start ? (u(), c("div", m({
            key: 0,
            class: t.cx("start")
          }, t.ptm("start")), [x(t.$slots, "start")], 16)) : p("", !0), h("ul", m({
            ref: i.listRef,
            id: t.$id + "_list",
            class: t.cx("list"),
            role: "menu",
            ...
            })], 16, et)) : p("", !0), (u(!0), c(P, null, B(s.items, function(d, f) {
              return u(), c(P, {
                key: d.label + l + "_" + f
              }, [i.visible(d) && !d.separator ? (u(), g(a, {
                key: 0,
                id: t.$id + "_" + l + "_" + f,
                item: d,
                templates: t.$slots,
                ...
                pt: t.pt
              }, null, 8, ["id", "item", "templates", "focusedOptionId", "unstyled", "onItemClick", "onItemMousemove", "pt"])) : i.visible(d) && d.separator ? (u(), c("li", m({
                key: "separator" + l + f,
            ...
            }), 128))], 64)) : i.visible(s) && s.separator ? (u(), c("li", m({
          ...
          }), 128))], 16, Ye), t.$slots.end ? (u(), c("div", m({
            key: 1,
            class: t.cx("end")
...
function ht(t, e, n, r, o, i) {
  ...
  return u(), c("ul", m({
    ...
    return u(), c(P, {
      key: i.getItemKey(s)
    }, [i.isItemVisible(s) && !i.getItemProp(s, "separator") ? (u(), c("li", m({
      key: 0,
      id: i.getItemId(s),
    ...
    }, null, 8, ["item", "root", "hasSubmenu", "label", "props"])) : ie((u(), c("a", m({
      key: 0,
      ...
      item: s.item,
      class: C(t.cx("itemIcon"))
    }, null, 8, ["item", "class"])) : i.getItemProp(s, "icon") ? (u(), c("span", m({
      key: 1,
      class: [t.cx("itemIcon"), i.getItemProp(s, "icon")],
      ref_for: !0
    }, i.getPTOptions(s, l, "itemIcon")), null, 16)) : p("", !0), h("span", m({
      ...
      ref_for: !0
    }, i.getPTOptions(s, l, "submenuIcon")), null, 16, ["class"]))], 64)) : p("", !0)], 16, ct)), [[b]])], 16, dt), i.isItemVisible(s) && i.isItemGroup(s) ? (u(), g(a, {
      key: 0,
    ...
    }, null, 8, ["id", "menuId", "style", "focusedItemId", "items", "mobileActive", "activeItemPath", "templates", "level", "aria-labelledby", "pt", "unstyled"])) : p("", !0)], 16, mt)) : p("", !0), i.isItemVisible(s) && i.getItemProp(s, "separator") ? (u(), c("li", m({
      key: 1,
      id: i.getItemId(s),
...
var de = {
  ...
  methods: {
    ...
    onItemChange: function(e, n) {
      ...
      if (!z(r)) {
        var i = r.index, a = r.key, b = r.level, s = r.parentKey, l = r.items, d = S(l), f = this.activeItemPath.filter(function(v) {
          return v.parentKey !== s && v.parentKey !== a;
        });
        d && f.push(r), this.focusedItemInfo = {
          index: i,
          level: b,
          parentKey: s
        }, d && (this.dirty = !0), o && k(this.menubar), !(n === "hover" && this.queryMatches) && (this.activeItemPath = f);
      }
    },
    onItemClick: function(e) {
      var n = e.originalEvent, r = e.processedItem, o = this.isProccessedItemGroup(r), i = z(r.parent), a = this.isSelected(r);
      if (a) {
        var b = r.index, s = r.key, l = r.level, d = r.parentKey;
    ...
    createProcessedItems: function(e) {
      ...
      return e && e.forEach(function(b, s) {
        ...
        d.items = n.createProcessedItems(b.items, r + 1, d, l), a.push(d);
      }), a;
    },
    containerRef: function(e) {
      this.container = e;
...
function yt(t, e, n, r, o, i) {
  ...
  return u(), c("div", m({
    ...
    var s;
    return [t.model && t.model.length > 0 ? (u(), c("a", m({
      key: 0,
      ref: "menubutton",
      role: "button",
      tabindex: "0",
  ...
  }, null, 8, ["id", "items", "templates", "mobileActive", "aria-activedescendant", "menuId", "focusedItemId", "activeItemPath", "aria-labelledby", "aria-label", "pt", "unstyled", "onFocus", "onBlur", "onKeydown", "onItemClick", "onItemMouseenter", "onItemMousemove"]), t.$slots.end ? (u(), c("div", m({
    key: 1,
    class: t.cx("end")
  }, t.ptm("end")), [x(t.$slots, "end")], 16)) : p("", !0)], 16);
}
de.render = yt;
const kt = { class: "bg-surface-0 dark:bg-surface-900" }, Lt = { class: "container" }, xt = { class: "flex items-center gap-5" }, Pt = { class: "hidden lg:flex items-center gap-5" }, Ct = { class: "lg:hidden" }, At = /* @__PURE__ */ _({
  ...
  setup(t) {
    ...
    ]), a = N(() => n.isSignedIn ? e.items : [...e.items || [], ...i.value]), b = N(() => [
      ...a.value,
      ...n.isSignedIn ? [
        {
          label: "Sign out",
